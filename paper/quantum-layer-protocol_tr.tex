...
\title{QUANTUM LAYER PROTOCOL: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, QUANTUM LAYER PROTOCOL'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
