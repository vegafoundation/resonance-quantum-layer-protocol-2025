...
\title{QUANTUM LAYER PROTOCOL: Концептуальная основа}
...
\begin{abstract}
Эта работа представляет QUANTUM LAYER PROTOCOL как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
\end{abstract}
