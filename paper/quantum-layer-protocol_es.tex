...
\title{QUANTUM LAYER PROTOCOL: Un Marco Conceptual}
...
\begin{abstract}
Este trabajo introduce QUANTUM LAYER PROTOCOL como un nuevo marco conceptual dentro del paradigma Resonance Data y QIRC.
\end{abstract}
